...
# library API, from a .map.in file.  The .map.in file is the first
# input file, and we expect the Makefile to have set the variables
# SYMVER_MIN and SYMVER_FLOOR.  See libcrypt.map.in and gen-vers.awk
# for explanations of the format of .map.in files.  See crypt-symbols.h
# for an explanation of how to use the macros generated by this program.
#
