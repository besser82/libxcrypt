...
/* Short-hand macro for all Argon2 flavours */
#define INCLUDE_argon2 INCLUDE_argon2d || INCLUDE_argon2i || INCLUDE_argon2id
...
#if INCLUDE_argon2
#define argon2_allocate_memory              _crypt_argon2_allocate_memory
#define argon2_b64len                       _crypt_argon2_b64len
#define argon2_clear_internal_memory        _crypt_argon2_clear_internal_memory
#define argon2_copy_block                   _crypt_argon2_copy_block
#define argon2_ctx                          _crypt_argon2_ctx
#define argon2_decode_string                _crypt_argon2_decode_string
#define argon2_encodedlen                   _crypt_argon2_encodedlen
#define argon2_encode_string                _crypt_argon2_encode_string
#define argon2_error_message                _crypt_argon2_error_message
#define argon2_fill_first_blocks            _crypt_argon2_fill_first_blocks
#define argon2_fill_memory_blocks           _crypt_argon2_fill_memory_blocks
#define argon2_fill_segment                 _crypt_argon2_fill_segment
#define argon2_finalize                     _crypt_argon2_finalize
#define argon2_FLAG_clear_internal_memory   _crypt_argon2_FLAG_clear_internal_memory
#define argon2_free_memory                  _crypt_argon2_free_memory
#define argon2_hash                         _crypt_argon2_hash
#define argon2_index_alpha                  _crypt_argon2_index_alpha
#define argon2_init_block_value             _crypt_argon2_init_block_value
#define argon2_initial_hash                 _crypt_argon2_initial_hash
#define argon2_initialize                   _crypt_argon2_initialize
#define argon2_numlen                       _crypt_argon2_numlen
#define argon2_thread_create                _crypt_argon2_thread_create
#define argon2_thread_exit                  _crypt_argon2_thread_exit
#define argon2_thread_join                  _crypt_argon2_thread_join
#define argon2_type2string                  _crypt_argon2_type2string
#define argon2_validate_inputs              _crypt_argon2_validate_inputs
#define argon2_verify                       _crypt_argon2_verify
#define argon2_verify_ctx                   _crypt_argon2_verify_ctx
#define argon2_xor_block                    _crypt_argon2_xor_block
